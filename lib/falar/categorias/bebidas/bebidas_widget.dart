...
/// aba com 3x6 botões representando Bebidas
class BebidasWidget extends StatefulWidget {
  const BebidasWidget({super.key});

  static String routeName = 'Bebidas';
  static String routePath = 'Bebidas';
