...
export 'comida_model.dart';

/// aba com 3x6 botões representando Comidas/Bebidas
class ComidaWidget extends StatefulWidget {
  ...
  static String routeName = 'Comida';
  static String routePath = 'Comida';
...
class _ComidaWidgetState extends State<ComidaWidget> {
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => ComidaModel());
  }
